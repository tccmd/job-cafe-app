          ...
          slivers: <Widget>[
            ...
            SliverList(
              delegate: SliverChildListDelegate([
                NoContent(imgUrl: 'assets/logo/MintChoco.png', imgWidth: 186.w, imgHeight: 136.h, title: '리뷰 준비 중!', subTitle: '2025년, 더 편리한 민트를 위해 준비중이에요', btnText: '준비되면 알림받기', function: () => p.updateUserConsents(context, u.uid, {'push_notification_consent': true}))
              ]),
            ),
          ],
        ),
